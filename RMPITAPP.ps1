...
$Form.controls.AddRange(@($Title,$RMPITlogo,$Panel1,$Panel2,$Panel3))
$Panel1.controls.AddRange(@($ActivateWindows,$Step1,$ChocolateyAllApps,$Step2,$Customiz,$Step3))
...
$ProcName = "chocolateappsinstall2.bat"
